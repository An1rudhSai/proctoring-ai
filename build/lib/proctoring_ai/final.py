...
def camera_thread():
    ...
    timeout = 60  # Run time in seconds
...
# Print results
print(f"Total run time: 60 seconds")
print(f"Head tilt time: {head_tilt_total_time/1.5:.2f} seconds")
print(f"Mouth opening time: {mouth_open_total_time/1.5:.2f} seconds")
