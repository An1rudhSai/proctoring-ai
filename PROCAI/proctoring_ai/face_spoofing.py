...
from PROCAI.proctoring_ai.face_detector import get_face_detector, find_faces
...
clf = joblib.load('models/face_spoofing.pkl')  # Make sure the path to your model is correct
